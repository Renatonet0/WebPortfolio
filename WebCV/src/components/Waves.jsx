// src/components/AWaves.js
import { Noise } from "noisejs"; // Importe a biblioteca Noise
...
class AWaves extends HTMLElement {
   ...
   */
    bindEvents() {
        ...
        this.updateMousePosition(e.clientX, e.clientY); // Use clientX e clientY
        });
    
        this.addEventListener("touchmove", (e) => {
        e.preventDefault();
        const touch = e.touches[0];
        this.updateMousePosition(touch.clientX, touch.clientY); // Use clientX e clientY
        });
    }
